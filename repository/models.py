...
class BusinessUnit(models.Model):
    ...
    contact = models.ForeignKey(UserGroup,related_name='c', on_delete=models.CASCADE) # 业务线联系人：1
    manager = models.ForeignKey(UserGroup,related_name='m', on_delete=models.CASCADE) # 运维管理人员：2
...
class Server(models.Model):
    ...
    business_unit = models.ForeignKey(BusinessUnit,null=True, blank=True, on_delete=models.CASCADE)
    ...
    latest_date = models.DateTimeField('最近更新时间',null=True, blank=True)
...
class ServerRecord(models.Model):
    ...
    """
    server_obj = models.ForeignKey('Server', related_name='ar', on_delete=models.CASCADE)
